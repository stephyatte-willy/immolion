...
interface DocumentProprietaireCardProps {
  document: any;
  onDelete: (id: number) => void;
  onUpdate?: (id: number, type: string, dateExpiration: string) => void;
}

export default function DocumentProprietaireCard({ 
  document, 
  onDelete, 
  onUpdate 
}: DocumentProprietaireCardProps) {
  ...
  return (
    <>
      <motion.div 
        className={`document-proprietaire-card ${isExpired ? 'expired' : ''}`}
